...
This is a set of R scripts  to reproduce the analysis of the paper 

Alberto Avritzer, Vincenzo Ferme, Andrea Janes, Barbara Russo, André van Hoorn, Henning Schulz, Daniel Menasch, Vilc Rufino

"Scalability Assessment of Microservice Architectural Configurations:A Domain-based Approach Leveraging Operational Profiles and Load Tests"

Experiments' data are included in the folder "DATA/Experiments"

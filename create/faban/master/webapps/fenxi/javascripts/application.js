...
ExperimentLoader = {
  disableExptForm: function() {
    Element.show('spinner');
    Form.disable('expt-form');
    Form.disable('compare-form');
  },

  enableExptForm: function(form) {
    Element.hide('spinner');
    Form.enable('expt-form');
    Form.enable('compare-form');
  }
}
...
CustomQueryExecutor = {
  loading: function() {
    Element.show('spinner');
    Form.disable('custom-query-form');
  },
  complete: function(form) {
    Element.hide('spinner');
    Form.enable('custom-query-form');
  }
}

...
Warbler::Config.new do |config|
  ...
  config.staging_dir = "../../dist"

  # Application directories to be included in the webapp.
  config.dirs = %w(app config lib log vendor )

  # Customizations for Fenxi
  config.war_name = "fenxi"
  ...
  config.java_libs.delete_if {|f| f =~ /jruby-core/ }
  config.java_libs.delete_if {|f| f =~ /jruby-stdlib/ }

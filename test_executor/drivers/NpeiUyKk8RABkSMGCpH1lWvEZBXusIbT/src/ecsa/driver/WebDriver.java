...
*/
@BenchmarkDefinition (
name    = "ECSA-NpeiUyKk8RABkSMGCpH1lWvEZBXusIbT",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkNpeiUyKk8RABkSMGCpH1lWvEZBXusIbT/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkNpeiUyKk8RABkSMGCpH1lWvEZBXusIbT/serverConfig/port");

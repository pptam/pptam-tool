...
*/
@BenchmarkDefinition (
name    = "ECSA-iwtlyGugGyohrtfQ9hjwehmpQOCIYYwb",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkiwtlyGugGyohrtfQ9hjwehmpQOCIYYwb/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkiwtlyGugGyohrtfQ9hjwehmpQOCIYYwb/serverConfig/port");

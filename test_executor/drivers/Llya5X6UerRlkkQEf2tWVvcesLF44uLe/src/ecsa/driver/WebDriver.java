...
*/
@BenchmarkDefinition (
name    = "ECSA-Llya5X6UerRlkkQEf2tWVvcesLF44uLe",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkLlya5X6UerRlkkQEf2tWVvcesLF44uLe/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkLlya5X6UerRlkkQEf2tWVvcesLF44uLe/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-rsluZ7JWVypt64ADuDK1jmYMSudxQQp0",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkrsluZ7JWVypt64ADuDK1jmYMSudxQQp0/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkrsluZ7JWVypt64ADuDK1jmYMSudxQQp0/serverConfig/port");

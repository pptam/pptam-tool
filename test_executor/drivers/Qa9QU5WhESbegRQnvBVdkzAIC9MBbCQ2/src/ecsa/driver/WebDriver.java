...
*/
@BenchmarkDefinition (
name    = "ECSA-Qa9QU5WhESbegRQnvBVdkzAIC9MBbCQ2",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkQa9QU5WhESbegRQnvBVdkzAIC9MBbCQ2/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkQa9QU5WhESbegRQnvBVdkzAIC9MBbCQ2/serverConfig/port");

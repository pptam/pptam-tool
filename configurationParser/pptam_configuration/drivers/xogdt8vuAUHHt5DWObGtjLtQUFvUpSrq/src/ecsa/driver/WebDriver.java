...
*/
@BenchmarkDefinition (
name    = "ECSA-xogdt8vuAUHHt5DWObGtjLtQUFvUpSrq",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkxogdt8vuAUHHt5DWObGtjLtQUFvUpSrq/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkxogdt8vuAUHHt5DWObGtjLtQUFvUpSrq/serverConfig/port");

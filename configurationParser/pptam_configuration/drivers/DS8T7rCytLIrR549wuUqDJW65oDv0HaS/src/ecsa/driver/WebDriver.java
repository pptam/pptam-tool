...
*/
@BenchmarkDefinition (
name    = "ECSA-DS8T7rCytLIrR549wuUqDJW65oDv0HaS",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkDS8T7rCytLIrR549wuUqDJW65oDv0HaS/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkDS8T7rCytLIrR549wuUqDJW65oDv0HaS/serverConfig/port");

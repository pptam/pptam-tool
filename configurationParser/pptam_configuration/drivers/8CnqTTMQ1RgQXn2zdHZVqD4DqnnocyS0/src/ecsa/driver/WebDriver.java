...
*/
@BenchmarkDefinition (
name    = "ECSA-8CnqTTMQ1RgQXn2zdHZVqD4DqnnocyS0",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmark8CnqTTMQ1RgQXn2zdHZVqD4DqnnocyS0/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmark8CnqTTMQ1RgQXn2zdHZVqD4DqnnocyS0/serverConfig/port");

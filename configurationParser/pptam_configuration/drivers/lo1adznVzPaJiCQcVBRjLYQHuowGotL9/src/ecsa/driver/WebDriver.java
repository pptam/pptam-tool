...
*/
@BenchmarkDefinition (
name    = "ECSA-lo1adznVzPaJiCQcVBRjLYQHuowGotL9",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarklo1adznVzPaJiCQcVBRjLYQHuowGotL9/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarklo1adznVzPaJiCQcVBRjLYQHuowGotL9/serverConfig/port");

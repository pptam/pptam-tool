...
*/
@BenchmarkDefinition (
name    = "ECSA-NxlTBvL74CDhHdneOeKOeInWd7IlhUZl",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkNxlTBvL74CDhHdneOeKOeInWd7IlhUZl/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkNxlTBvL74CDhHdneOeKOeInWd7IlhUZl/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-yusrph2Bmt9F5FTADwdM3THmge0C4XHA",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkyusrph2Bmt9F5FTADwdM3THmge0C4XHA/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkyusrph2Bmt9F5FTADwdM3THmge0C4XHA/serverConfig/port");

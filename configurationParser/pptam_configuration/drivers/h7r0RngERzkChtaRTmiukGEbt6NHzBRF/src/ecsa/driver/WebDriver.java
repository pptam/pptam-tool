...
*/
@BenchmarkDefinition (
name    = "ECSA-h7r0RngERzkChtaRTmiukGEbt6NHzBRF",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkh7r0RngERzkChtaRTmiukGEbt6NHzBRF/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkh7r0RngERzkChtaRTmiukGEbt6NHzBRF/serverConfig/port");

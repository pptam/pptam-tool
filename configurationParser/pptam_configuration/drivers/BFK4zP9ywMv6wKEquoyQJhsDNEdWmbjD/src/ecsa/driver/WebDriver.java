...
*/
@BenchmarkDefinition (
name    = "ECSA-BFK4zP9ywMv6wKEquoyQJhsDNEdWmbjD",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkBFK4zP9ywMv6wKEquoyQJhsDNEdWmbjD/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkBFK4zP9ywMv6wKEquoyQJhsDNEdWmbjD/serverConfig/port");

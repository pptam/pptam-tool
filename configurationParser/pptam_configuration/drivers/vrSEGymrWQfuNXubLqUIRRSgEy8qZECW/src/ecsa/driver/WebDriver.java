...
*/
@BenchmarkDefinition (
name    = "ECSA-vrSEGymrWQfuNXubLqUIRRSgEy8qZECW",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkvrSEGymrWQfuNXubLqUIRRSgEy8qZECW/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkvrSEGymrWQfuNXubLqUIRRSgEy8qZECW/serverConfig/port");

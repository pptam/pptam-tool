...
*/
@BenchmarkDefinition (
name    = "ECSA-iAWo4BWxFwoLgF1yVnBrP8HLgUSVoVyC",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkiAWo4BWxFwoLgF1yVnBrP8HLgUSVoVyC/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkiAWo4BWxFwoLgF1yVnBrP8HLgUSVoVyC/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-aJT1qkrt3AjiG4XKhbqLWogouTOcrMda",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkaJT1qkrt3AjiG4XKhbqLWogouTOcrMda/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkaJT1qkrt3AjiG4XKhbqLWogouTOcrMda/serverConfig/port");

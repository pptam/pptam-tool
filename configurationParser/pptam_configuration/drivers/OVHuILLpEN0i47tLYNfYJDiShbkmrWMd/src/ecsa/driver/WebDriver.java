...
*/
@BenchmarkDefinition (
name    = "ECSA-OVHuILLpEN0i47tLYNfYJDiShbkmrWMd",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkOVHuILLpEN0i47tLYNfYJDiShbkmrWMd/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkOVHuILLpEN0i47tLYNfYJDiShbkmrWMd/serverConfig/port");

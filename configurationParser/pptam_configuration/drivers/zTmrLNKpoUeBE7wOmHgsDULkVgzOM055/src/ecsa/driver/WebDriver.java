...
*/
@BenchmarkDefinition (
name    = "ECSA-zTmrLNKpoUeBE7wOmHgsDULkVgzOM055",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkzTmrLNKpoUeBE7wOmHgsDULkVgzOM055/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkzTmrLNKpoUeBE7wOmHgsDULkVgzOM055/serverConfig/port");

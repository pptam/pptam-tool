...
*/
@BenchmarkDefinition (
name    = "ECSA-6WngESmoJu4h9V8T4cQR4DYqS17CMeyh",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmark6WngESmoJu4h9V8T4cQR4DYqS17CMeyh/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmark6WngESmoJu4h9V8T4cQR4DYqS17CMeyh/serverConfig/port");

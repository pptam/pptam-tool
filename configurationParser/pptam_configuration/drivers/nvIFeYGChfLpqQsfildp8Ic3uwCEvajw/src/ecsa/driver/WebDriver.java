...
*/
@BenchmarkDefinition (
name    = "ECSA-nvIFeYGChfLpqQsfildp8Ic3uwCEvajw",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarknvIFeYGChfLpqQsfildp8Ic3uwCEvajw/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarknvIFeYGChfLpqQsfildp8Ic3uwCEvajw/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-qzyzoXRQeRLDDaJO1GGkFi7shmBoFIvM",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkqzyzoXRQeRLDDaJO1GGkFi7shmBoFIvM/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkqzyzoXRQeRLDDaJO1GGkFi7shmBoFIvM/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-reCQhoSn2nvxuJToScF9krDKInoHacqG",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkreCQhoSn2nvxuJToScF9krDKInoHacqG/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkreCQhoSn2nvxuJToScF9krDKInoHacqG/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-8DHPJIgCcUAMJ9ovVPFTWmm7aJyjy97b",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmark8DHPJIgCcUAMJ9ovVPFTWmm7aJyjy97b/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmark8DHPJIgCcUAMJ9ovVPFTWmm7aJyjy97b/serverConfig/port");

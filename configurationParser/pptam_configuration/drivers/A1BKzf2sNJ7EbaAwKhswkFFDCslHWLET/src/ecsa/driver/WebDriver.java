...
*/
@BenchmarkDefinition (
name    = "ECSA-A1BKzf2sNJ7EbaAwKhswkFFDCslHWLET",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkA1BKzf2sNJ7EbaAwKhswkFFDCslHWLET/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkA1BKzf2sNJ7EbaAwKhswkFFDCslHWLET/serverConfig/port");

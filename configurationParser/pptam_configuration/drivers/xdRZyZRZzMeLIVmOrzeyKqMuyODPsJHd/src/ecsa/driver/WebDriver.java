...
*/
@BenchmarkDefinition (
name    = "ECSA-xdRZyZRZzMeLIVmOrzeyKqMuyODPsJHd",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkxdRZyZRZzMeLIVmOrzeyKqMuyODPsJHd/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkxdRZyZRZzMeLIVmOrzeyKqMuyODPsJHd/serverConfig/port");

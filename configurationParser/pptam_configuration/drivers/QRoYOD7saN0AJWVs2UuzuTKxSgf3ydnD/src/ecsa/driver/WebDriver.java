...
*/
@BenchmarkDefinition (
name    = "ECSA-QRoYOD7saN0AJWVs2UuzuTKxSgf3ydnD",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkQRoYOD7saN0AJWVs2UuzuTKxSgf3ydnD/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkQRoYOD7saN0AJWVs2UuzuTKxSgf3ydnD/serverConfig/port");

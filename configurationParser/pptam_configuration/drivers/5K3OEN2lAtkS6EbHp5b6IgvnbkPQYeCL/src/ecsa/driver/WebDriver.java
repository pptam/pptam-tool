...
*/
@BenchmarkDefinition (
name    = "ECSA-5K3OEN2lAtkS6EbHp5b6IgvnbkPQYeCL",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmark5K3OEN2lAtkS6EbHp5b6IgvnbkPQYeCL/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmark5K3OEN2lAtkS6EbHp5b6IgvnbkPQYeCL/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-MDoncrxQmuegRTeloFxRLuUgl3JJxmG6",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkMDoncrxQmuegRTeloFxRLuUgl3JJxmG6/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkMDoncrxQmuegRTeloFxRLuUgl3JJxmG6/serverConfig/port");

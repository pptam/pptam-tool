...
*/
@BenchmarkDefinition (
name    = "ECSA-pVipR84yxZccPoo4ey9uzppkIomdTFMa",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkpVipR84yxZccPoo4ey9uzppkIomdTFMa/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkpVipR84yxZccPoo4ey9uzppkIomdTFMa/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-HT8HZx2kJB9rftWCYVxTKNweAhtBFRjZ",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkHT8HZx2kJB9rftWCYVxTKNweAhtBFRjZ/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkHT8HZx2kJB9rftWCYVxTKNweAhtBFRjZ/serverConfig/port");

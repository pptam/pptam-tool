...
*/
@BenchmarkDefinition (
name    = "ECSA-Gcqr5MmzvdlqlvIuOQPvzIXredsH7nqV",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkGcqr5MmzvdlqlvIuOQPvzIXredsH7nqV/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkGcqr5MmzvdlqlvIuOQPvzIXredsH7nqV/serverConfig/port");

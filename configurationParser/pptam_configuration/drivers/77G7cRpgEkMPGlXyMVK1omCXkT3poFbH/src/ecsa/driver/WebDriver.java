...
*/
@BenchmarkDefinition (
name    = "ECSA-77G7cRpgEkMPGlXyMVK1omCXkT3poFbH",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmark77G7cRpgEkMPGlXyMVK1omCXkT3poFbH/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmark77G7cRpgEkMPGlXyMVK1omCXkT3poFbH/serverConfig/port");

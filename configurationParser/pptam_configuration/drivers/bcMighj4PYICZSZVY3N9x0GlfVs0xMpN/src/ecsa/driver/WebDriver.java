...
*/
@BenchmarkDefinition (
name    = "ECSA-bcMighj4PYICZSZVY3N9x0GlfVs0xMpN",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkbcMighj4PYICZSZVY3N9x0GlfVs0xMpN/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkbcMighj4PYICZSZVY3N9x0GlfVs0xMpN/serverConfig/port");

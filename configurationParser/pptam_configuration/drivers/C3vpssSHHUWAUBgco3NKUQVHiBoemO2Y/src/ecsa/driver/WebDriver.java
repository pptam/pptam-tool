...
*/
@BenchmarkDefinition (
name    = "ECSA-C3vpssSHHUWAUBgco3NKUQVHiBoemO2Y",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkC3vpssSHHUWAUBgco3NKUQVHiBoemO2Y/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkC3vpssSHHUWAUBgco3NKUQVHiBoemO2Y/serverConfig/port");

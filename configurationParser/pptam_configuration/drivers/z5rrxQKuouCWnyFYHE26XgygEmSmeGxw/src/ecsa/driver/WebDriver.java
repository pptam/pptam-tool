...
*/
@BenchmarkDefinition (
name    = "ECSA-z5rrxQKuouCWnyFYHE26XgygEmSmeGxw",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkz5rrxQKuouCWnyFYHE26XgygEmSmeGxw/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkz5rrxQKuouCWnyFYHE26XgygEmSmeGxw/serverConfig/port");

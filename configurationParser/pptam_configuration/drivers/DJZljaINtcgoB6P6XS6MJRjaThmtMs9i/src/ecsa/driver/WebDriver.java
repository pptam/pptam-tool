...
*/
@BenchmarkDefinition (
name    = "ECSA-DJZljaINtcgoB6P6XS6MJRjaThmtMs9i",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkDJZljaINtcgoB6P6XS6MJRjaThmtMs9i/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkDJZljaINtcgoB6P6XS6MJRjaThmtMs9i/serverConfig/port");

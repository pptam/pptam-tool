...
*/
@BenchmarkDefinition (
name    = "ECSA-isPfAjZ5o1w3nHRH0KKO1qPRLomg5OIO",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkisPfAjZ5o1w3nHRH0KKO1qPRLomg5OIO/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkisPfAjZ5o1w3nHRH0KKO1qPRLomg5OIO/serverConfig/port");

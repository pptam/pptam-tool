...
*/
@BenchmarkDefinition (
name    = "ECSA-BtgPrNq6TWYb2qgUDelzJ78SG10X8RTt",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkBtgPrNq6TWYb2qgUDelzJ78SG10X8RTt/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkBtgPrNq6TWYb2qgUDelzJ78SG10X8RTt/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-a4vZNqlhgByggNE4TvMb4ASEwZVsZtHt",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarka4vZNqlhgByggNE4TvMb4ASEwZVsZtHt/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarka4vZNqlhgByggNE4TvMb4ASEwZVsZtHt/serverConfig/port");

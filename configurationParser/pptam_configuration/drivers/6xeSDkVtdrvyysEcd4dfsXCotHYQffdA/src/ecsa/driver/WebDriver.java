...
*/
@BenchmarkDefinition (
name    = "ECSA-6xeSDkVtdrvyysEcd4dfsXCotHYQffdA",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmark6xeSDkVtdrvyysEcd4dfsXCotHYQffdA/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmark6xeSDkVtdrvyysEcd4dfsXCotHYQffdA/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-Dkeuj9r7LZc2QrNDvKCjuAUNbMcfo9w8",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkDkeuj9r7LZc2QrNDvKCjuAUNbMcfo9w8/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkDkeuj9r7LZc2QrNDvKCjuAUNbMcfo9w8/serverConfig/port");

...
class Requests():
    ...
    def search_ticket(self, departure_date, from_station, to_station):
        ...
        with self.client.post(
            ...
            do_log({'timestamp': int(time.time()), 'name': sys._getframe().f_code.co_name, 'level': 'debug', 'status_code': response.status_code,
    ...
    def _create_user(self, _expected):
        ...
        with self.client.post(url="/api/v1/users/login",
            ...
            do_log({'timestamp': int(time.time()), 'name': sys._getframe().f_code.co_name, 'level': 'debug', 'status_code': response1.status_code,
        ...
        with self.client.post(url="/api/v1/adminuserservice/users",
            ...
            do_log({'timestamp': int(time.time()), 'name': sys._getframe().f_code.co_name, 'level': 'debug', 'status_code': response2.status_code,
    ...
    def select_contact(self, _expected):
        ...
        do_log({'timestamp': int(time.time()), 'name': sys._getframe().f_code.co_name, 'level': 'debug', 'status_code': response_contacts.status_code,
    ...
    def select_order(self, _expected):
        ...
        do_log({'timestamp': int(time.time()), 'name': sys._getframe().f_code.co_name, 'level': 'debug', 'status_code': response_order_refresh.status_code,
    ...
    def confirm_consign(self, expected):
        ...
        if(expected):
            ...
            do_log({'timestamp': int(time.time()), 'name': sys._getframe().f_code.co_name, 'level': 'debug', 'status_code': response_as_json_consign.status_code,

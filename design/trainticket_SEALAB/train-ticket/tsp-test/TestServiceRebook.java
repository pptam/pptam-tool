...
public class TestServiceRebook {
    ...
    public void testTicketRebook()throws Exception{
        ...
        if ("".equals(statusRebook)) {
            ...
            Assert.assertEquals(!"".equals(statusRebook), false);
        }
        else if (statusRebook.startsWith("You haven't paid")){
            System.out.println("Failed, You haven't paid the original ticket!");
            Assert.assertEquals(statusRebook.startsWith("true"), false);
        }
        else if (statusRebook.startsWith("You can only change the ticket")) {
            System.out.println("Failed, the ticket you rebook is expired!");
            Assert.assertEquals(statusRebook.startsWith("true"), false);
        }
            ...
            Assert.assertEquals(statusRebookPayment.startsWith("true"), false);
        }
        else {

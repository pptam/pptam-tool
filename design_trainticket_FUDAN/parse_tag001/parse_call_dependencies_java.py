...
def main():
    ...
    subfolders_to_traverse = ["ts-login-service", "ts-route-service", "ts-register-service", "ts-sso-service", "ts-verification-code-service", "ts-contacts-service", "ts-order-service", "ts-order-other-service", "ts-config-service", "ts-station-service", "ts-train-service", "ts-travel-service", "ts-travel2-service", "ts-preserve-service", "ts-preserve-other-service", "ts-basic-service", "ts-ticketinfo-service", "ts-price-service", "ts-notification-service", "ts-security-service", "ts-inside-payment-service", "ts-execute-service", "ts-payment-service", "ts-rebook-service", "ts-cancel-service", "ts-assurance-service", "ts-travel-plan-service", "ts-food-map-service", "ts-route-plan-service", "ts-consign-price-service", "ts-consign-service", "ts-food-service", "ts-seat-service"]

...
*/
@BenchmarkDefinition (
name    = "ECSA-kCPpnw4eDebRFHgeFuDxOehnvEpWjpaO",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarkkCPpnw4eDebRFHgeFuDxOehnvEpWjpaO/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarkkCPpnw4eDebRFHgeFuDxOehnvEpWjpaO/serverConfig/port");

...
*/
@BenchmarkDefinition (
name    = "ECSA-sPYDbhLOGPKPecu5ogZGmBOa7KKs3KAd",
version = "0.2"
)
@BenchmarkDriver (
name           = "WebDriver",
...
String host = ctx.getXPathValue("/webBenchmarksPYDbhLOGPKPecu5ogZGmBOa7KKs3KAd/serverConfig/host");
String port = ctx.getXPathValue("/webBenchmarksPYDbhLOGPKPecu5ogZGmBOa7KKs3KAd/serverConfig/port");

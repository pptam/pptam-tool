...
class CommonMethods:
    ...
    def copyFromFolder2Folder(self, folderOriginRelPath, folderTargetRelPath):
        ...
        try:
            ...
            print("Copy "+folderOriginAbsPath+"->" +
                  folderTargetAbsPath+" - SUCCESSFUL")
    ...
    def removeFileRelativePath(self, pathRel):
        ...
        if not os.path.isfile(pathAbs):
            print("[WARNING] CommonMethods::removeFileRelativePath::File " +
                  pathAbs + " does not exist.")
            return
        else:
            try:
                os.remove(pathAbs)
                print("CommonMethods::removeFileRelativePath::File " +
                      pathAbs + " - DELETED")
            except:
                print(
                    "[WARNING] CommonMethods::removeFileRelativePath::Cannot delete file " + pathAbs + ".")
    ...
    def replaceValueInFileWithTempFile(self, paramPlaceHolder, paramValue, pathToBuildProperties):
        ...
        if (os.path.isfile(pathToBuildProperties+".tmp")):
            ...
            print("replaceValueInFileWithTempFile:No file at " +
                  pathToBuildProperties+".")
            return
    ...
    def replaceValueInFileRelPath(self, paramPlaceHolder, paramValue, pathToFileOrigin):
        ...
        self.replaceValueInFile(
            paramPlaceHolder, paramValue, pathToFileOriginAbs)

    ...
    def parseJSONConfigFile(self, configurationFilePath_JSON):
        ...
        while True:
            ...
            if command in self.configurationJSON["PPTAM_Configuration"]:
                preExecExternalCommands.append(
                    self.configurationJSON["PPTAM_Configuration"][command])
        ...
        while True:
            ...
            if command in self.configurationJSON["PPTAM_Configuration"]:
                postExecExternalCommands.append(
                    self.configurationJSON["PPTAM_Configuration"][command])
                # print(command+"="+self.configurationJSON["PPTAM_Configuration"][command])
        ...
        self.systemConfigurationData.setPPTAMConfigurationData(
        ...
        CARTS_CPUS_RESERVATIONS = self.configurationJSON[
            "Docker_Configuration"]["CARTS_CPUS_RESERVATIONS"]
        ...
        self.systemConfigurationData.setDockerConfigurationData(
